...
public class DocumentCodecProvider implements CodecProvider {
     ...
     * @see mochi.tool.bson.codecs.DocumentCodec#DocumentCodec(mochi.tool.bson.codecs.configuration.CodecRegistry, BsonTypeClassMap, mochi.tool.bson.Transformer)
     */
