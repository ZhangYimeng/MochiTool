...
import mochi.tool.bson.codecs.Decoder;
import mochi.tool.bson.codecs.DecoderContext;
import mochi.tool.bson.codecs.DocumentCodec;
import mochi.tool.bson.codecs.Encoder;
...
public class Document implements Map<String, Object>, Serializable, Bson {
     ...
     * @throws mochi.tool.bson.codecs.configuration.CodecConfigurationException if the document contains types not in the default registry
     */
     ...
     * @return a JSON representation of this document
     * @throws mochi.tool.bson.codecs.configuration.CodecConfigurationException if the registry does not contain a codec for the document values.
     */
