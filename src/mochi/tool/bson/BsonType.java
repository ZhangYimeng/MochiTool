...
public enum BsonType {
	...
	private static final BsonType[] LOOKUP_TABLE = new BsonType[MIN_KEY
			.getValue() + 1];
	 ...
	 * 
	 * @param value
	 *            the int value of the desired BSON type.
	...
	/**
	 * Returns whether this type is some sort of containing type, e.g. a
	 * document or array.
	 * 
	 * @return true if this is some sort of containing type rather than a
	 *         primitive value
	 */
