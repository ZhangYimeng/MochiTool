...
public abstract class AbstractBsonReader implements Closeable, BsonReader {
    ...
    /**
     * Returns the next {@code State} to transition to, based on the {@link mochi.tool.bson.AbstractBsonReader.Context} of this reader.
     *
     ...
     * reader. Also records the {@link mochi.tool.bson.BsonContextType}, indicating whether the reader is reading a document, array, or other
