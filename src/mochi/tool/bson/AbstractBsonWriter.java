...
public abstract class AbstractBsonWriter implements BsonWriter, Closeable {
     ...
     * @see #throwInvalidState(String, mochi.tool.bson.AbstractBsonWriter.State...)
     */
     ...
     * reader. Also records the {@link mochi.tool.bson.BsonContextType}, indicating whether the writer is reading a document, array, or other
    ...
    /**
     * Capture the current state of this writer - its {@link mochi.tool.bson.AbstractBsonWriter.Context}, {@link
     * mochi.tool.bson.AbstractBsonWriter.State}, field name and depth.
     */
