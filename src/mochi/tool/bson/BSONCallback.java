...
public interface BSONCallback {
     ...
     * @see mochi.tool.bson.BsonType#NULL
     */
    void gotNull(String name);

    /**
     * Called when reading a field with a {@link mochi.tool.bson.BsonType#UNDEFINED} value.
     *
     * @param name the name of the field
     * @see mochi.tool.bson.BsonType#UNDEFINED
     */
    void gotUndefined(String name);

    /**
     * Called when reading a field with a {@link mochi.tool.bson.BsonType#MIN_KEY} value.
     *
     * @param name the name of the field
     */
    ...
    /**
     * Called when reading a field with a {@link mochi.tool.bson.BsonType#MAX_KEY} value.
     *
     * @param name the name of the field
     */
    ...
    /**
     * Called when reading a field with a {@link mochi.tool.bson.BsonType#BOOLEAN} value.
     *
     * @param name  the name of the field
    ...
    /**
     * Called when reading a field with a {@link mochi.tool.bson.BsonType#DOUBLE} value.
     *
     * @param name  the name of the field
     * @param value the field's value
     */
    ...
    /**
     * Called when reading a field with a {@link mochi.tool.bson.BsonType#INT32} value.
     *
     * @param name  the name of the field
     * @param value the field's value
     */
    ...
    /**
     * Called when reading a field with a {@link mochi.tool.bson.BsonType#INT64} value.
     *
     * @param name  the name of the field
     * @param value the field's value
     */
    ...
    /**
     * Called when reading a field with a {@link mochi.tool.bson.BsonType#DATE_TIME} value.
     *
     * @param name   the name of the field
    ...
    /**
     * Called when reading a field with a {@link mochi.tool.bson.BsonType#STRING} value.
     *
     * @param name  the name of the field
     * @param value the field's value
     */
    ...
    /**
     * Called when reading a field with a {@link mochi.tool.bson.BsonType#SYMBOL} value.
     *
     * @param name  the name of the field
     * @param value the field's value
     */
    ...
    /**
     * Called when reading a field with a {@link mochi.tool.bson.BsonType#REGULAR_EXPRESSION} value.
     *
     * @param name    the name of the field
    ...
    /**
     * Called when reading a field with a {@link mochi.tool.bson.BsonType#TIMESTAMP} value.
     *
     * @param name      the name of the field
    ...
    /**
     * Called when reading a field with a {@link mochi.tool.bson.BsonType#OBJECT_ID} value.
     *
     * @param name the name of the field
    ...
    /**
     * Invoked when {@link mochi.tool.bson.BSONDecoder} encountered a {@link mochi.tool.bson.BsonType#DB_POINTER} type field in a byte sequence.
     *
     * @param name      the name of the field
    ...
    /**
     * Called when reading a field with a {@link mochi.tool.bson.BsonType#BINARY} value. Note that binary values have a subtype, which may
     * determine how the value is processed.
     *
     * @param name the name of the field
     * @param type one of the binary subtypes: {@link mochi.tool.bson.BsonBinarySubType}
     * @param data the field's value
     */
     ...
     * {@link mochi.tool.bson.BsonBinarySubType#UUID_LEGACY}
     *
     * @param name  the name of the field
    ...
    /**
     * Called when reading a field with a {@link mochi.tool.bson.BsonType#JAVASCRIPT} value.
     *
     * @param name the name of the field
    ...
    /**
     * Called when reading a field with a {@link mochi.tool.bson.BsonType#JAVASCRIPT_WITH_SCOPE} value.
     *
     * @param name  the name of the field
     * @param code  the JavaScript code
