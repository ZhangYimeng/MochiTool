...
public class MessageProtocolConfig {
	...
	public static String ERR_DEVICE_NOT_EXISTS = "12";
	public static String ERR_DEVICE_NOT_EXISTS_MESSAGE = "设备ID不存在。";
	public static String ERR_USERNAME_WRONG = "13";
	public static String ERR_USERNAME_WRONG_MESSAGE = "用户名错误，导致设备不能从数据库初始化上传数据时间间隔信息。";
	public static String ERR_DEVICE_NOT_ONLINE = "14";
	public static String ERR_DEVICE_NOT_ONLINE_MESSAGE = "设备离线。";
	public static String ERR_DATASOURCE_NOT_EXIST = "15";
	public static String ERR_DATASOURCE_NOT_EXIST_MESSAGE = "数据源不存在。";
