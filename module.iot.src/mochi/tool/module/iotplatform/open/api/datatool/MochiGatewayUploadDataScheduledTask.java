...
public class MochiGatewayUploadDataScheduledTask extends ScheduledTask {
	...
	public MochiGatewayUploadDataScheduledTask(MochiGatewayConnector conn) {
		MochiGatewayUploadDataScheduledTask.interval = 0;
		MochiGatewayUploadDataScheduledTask.conn = conn;
	}
	...
	public void setInterval(long interval) {
		MochiGatewayUploadDataScheduledTask.interval = interval;
	...
	public static void setUploadDataTaskReadyFlag(boolean readyFlag) {
		MochiGatewayUploadDataScheduledTask.readyFlag = readyFlag;
	}
